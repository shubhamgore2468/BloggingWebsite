...
// .wrangler/tmp/bundle-KOAARN/checked-fetch.js
  ...
  "node_modules/.prisma/client/edge.js"(exports) {
    ...
    var config = {
      "generator": {
        ...
        "output": {
          "value": "/Users/shubhamgore/Development/100x/week-13/backend/node_modules/@prisma/client",
          "fromEnvVar": null
        },
        "config": {
          "engineType": "library"
        ...
        "previewFeatures": [],
        "sourceFilePath": "/Users/shubhamgore/Development/100x/week-13/backend/prisma/schema.prisma"
      },
      "relativeEnvPaths": {
        "rootEnvPath": null,
        "schemaEnvPath": "../../../.env"
...
// node_modules/@shubham18218/medium-common/dist/index.js
var require_dist = __commonJS({
  "node_modules/@shubham18218/medium-common/dist/index.js"(exports) {
    "use strict";
    init_checked_fetch();
    init_modules_watch_stub();
    var __importDefault = exports && exports.__importDefault || function(mod) {
...
// .wrangler/tmp/bundle-KOAARN/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-KOAARN/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
...
userRoute.post("/signup", async (c) => {
  ...
  try {
    ...
    const jwt_token = await sign2({ id: user.id }, c.env.JWT_TOKEN);
    return c.json({
      jwt: jwt_token,
...
userRoute.post("/signin", async (c) => {
  ...
  const jwt2 = await sign2({ id: user.id }, c.env.JWT_TOKEN);
  return c.json({
    jwt: jwt2,
...
blogRoute.use("/*", async (c, next) => {
  ...
  try {
    const user = await verify2(authHeader, c.env.JWT_TOKEN);
    if (user) {
